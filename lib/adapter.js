import { buildFullPath, settle, createError } from './helper'
...
export default function uniAdapter(config) {
  return new Promise(function (resolve, reject) {
    ...
    if (requestData && method === 'POST' && requestHeaders['Content-Type'] === 'multipart/form-data') {
      /**
    ...
    } else if (requestData && method === 'GET' && typeof config.onDownloadProgress === 'function') {
